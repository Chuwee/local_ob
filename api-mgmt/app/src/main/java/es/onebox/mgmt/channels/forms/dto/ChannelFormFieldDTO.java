...
public class ChannelFormFieldDTO implements Serializable {
    ...
    private List<DynamicFormValidatorDTO> appliedRules;
    ...
    public List<DynamicFormValidatorDTO> getAppliedRules() {
        return appliedRules;
    }

    public void setAppliedRules(List<DynamicFormValidatorDTO> appliedRules) {
