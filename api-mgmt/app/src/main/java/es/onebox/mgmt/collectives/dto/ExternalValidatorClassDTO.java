...
public class ExternalValidatorClassDTO implements Serializable {

    private static final long serialVersionUID = -2788777927566733825L;

    private String name;
    @JsonProperty("execution_class")
