...
public class UpdateChannelLoyaltyPointsDTO implements Serializable {
    ...
    public MaxLoyaltyPointsPerPurchaseDTO getMaxLoyaltyPointsPerPurchase() {
        return maxLoyaltyPointsPerPurchase;
    }
    ...
    public LoyaltyPointsPercentagePerPurchaseDTO getLoyaltyPointsPercentagePerPurchase() {
        return loyaltyPointsPercentagePerPurchase;
    }
