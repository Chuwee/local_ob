...
public class UpdateEntityTextBlockDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = -3646936007576458033L;
    ...
    public UpdateEntityTextBlockDTO() {
    }
