...
public class SessionDate implements Serializable {
    ...
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
    private ZonedDateTime realEndSession;
    ...
    public ZonedDateTime getRealEndSession() {
        return realEndSession;
    }

    public void setRealEndSession(ZonedDateTime realEndSession) {
        this.realEndSession = realEndSession;
    }
