...
public class MemberConfigsDTO implements Serializable {
    ...
    @JsonProperty("subscription_modes")
    private List<SubscriptionModeDTO> subscriptionModes;
    ...
    @JsonProperty("prices_batch_enabled")
    ...
    @JsonProperty("membership_term_id")
    private Long membershipTermId;
    @JsonProperty("membership_periodicity_id")
    ...
    public List<SubscriptionModeDTO> getSubscriptionModes() {
        return subscriptionModes;
    }

    public void setSubscriptionModes(List<SubscriptionModeDTO> subscriptionModes) {
