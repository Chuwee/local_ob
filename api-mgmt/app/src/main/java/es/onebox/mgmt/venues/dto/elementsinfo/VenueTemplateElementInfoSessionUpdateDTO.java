...
public class VenueTemplateElementInfoSessionUpdateDTO extends VenueTemplateElementDefaultInfoUpdateDTO{

    @Serial
    private static final long serialVersionUID = -2727349071984049628L;
