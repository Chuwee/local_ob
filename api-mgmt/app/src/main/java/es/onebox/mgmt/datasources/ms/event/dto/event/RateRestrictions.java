...
public class RateRestrictions implements Serializable {
    ...
    private EventRateDateRestriction dateRestriction;
    private Boolean customerTypeRestrictionEnabled;
    private List<IdCodeDTO> customerTypeRestriction;
    ...
    private RatePriceZoneRestriction ratePriceZoneRestriction;
    ...
    public EventRateDateRestriction getDateRestriction() {
        return dateRestriction;
    }

    public void setDateRestriction(EventRateDateRestriction dateRestriction) {
    ...
    public List<IdCodeDTO> getCustomerTypeRestriction() {
        return customerTypeRestriction;
    }

    public void setCustomerTypeRestriction(List<IdCodeDTO> customerTypeRestriction) {
    ...
    public RatePriceZoneRestriction getRatePriceZoneRestriction() {
        return ratePriceZoneRestriction;
    }

    public void setRatePriceZoneRestriction(RatePriceZoneRestriction ratePriceZoneRestriction) {
        this.ratePriceZoneRestriction = ratePriceZoneRestriction;
    }
}
