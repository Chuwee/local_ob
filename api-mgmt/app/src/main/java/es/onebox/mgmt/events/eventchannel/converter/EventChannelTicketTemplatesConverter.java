package es.onebox.mgmt.events.eventchannel.converter;
...
public class EventChannelTicketTemplatesConverter {

    private EventChannelTicketTemplatesConverter() {
    ...
    public static UpdateEventChannel toEventChannel(Long eventId, EventTicketTemplateType type, TicketTemplateFormatPath templateFormat, IdDTO templateId) {
        ...
        updateEventChannel.setTicketTemplates(ticketTemplates);
