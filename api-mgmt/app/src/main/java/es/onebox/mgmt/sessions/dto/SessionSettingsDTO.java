...
public class SessionSettingsDTO implements Serializable {

    @Serial
    private static final long serialVersionUID = -5896419300412452358L;
    ...
    @JsonProperty("enable_presale")
    private Boolean enablePresale;

    @JsonProperty("smart_booking")
    private SessionSmartBookingDTO smartBooking;
    ...
    public Boolean getEnablePresale() {
        return enablePresale;
    }

    public void setEnablePresale(Boolean enablePresale) {
        this.enablePresale = enablePresale;
    }

    public SessionSmartBookingDTO getSmartBooking() {
        return smartBooking;
    }

    public void setSmartBooking(SessionSmartBookingDTO smartBooking) {
