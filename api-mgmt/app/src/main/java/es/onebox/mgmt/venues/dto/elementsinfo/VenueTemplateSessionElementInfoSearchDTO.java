...
@MaxLimit(50)
public class VenueTemplateSessionElementInfoSearchDTO extends VenueTemplateElementInfoSearchDTO {

    @Serial
    private static final long serialVersionUID = -7184870573034100544L;
