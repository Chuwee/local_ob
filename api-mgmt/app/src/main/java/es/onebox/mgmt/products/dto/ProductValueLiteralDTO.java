...
public class ProductValueLiteralDTO implements Serializable {
    ...
    public ProductValueLiteralDTO(Long valueId, String key, String value) {
        this.valueId = valueId;
        this.key = key;
        this.value = value;
    }

    public ProductValueLiteralDTO(Long valueId, String key, String value, Boolean richText, Boolean auditable, String language) {
        this.valueId = valueId;
        this.key = key;
        this.value = value;
