...
public class CustomerConfig implements Serializable {
    ...
    private List<CustomerRestrictions> restrictions;
    ...
    public List<CustomerRestrictions> getRestrictions() {
        return restrictions;
    }

    public void setRestrictions(List<CustomerRestrictions> restrictions) {
