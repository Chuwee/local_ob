...
@Component({
    imports: [CommonModule, MaterialModule, TranslatePipe, ReactiveFormsModule, FlexLayoutModule],
    selector: 'app-add-value',
    templateUrl: './add-value.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class NewValueDialogComponent
    extends ObDialog<NewValueDialogComponent, {
        placeHolder: string; arrayValidator?: string[]; email?: boolean;
    }, {
        newValue: string;
    }> {
