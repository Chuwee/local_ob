import { PackItem, PutPackItem } from '@admin-clients/cpanel/channels/packs/data-access';
...
import {
    CurrencyInputComponent, EphemeralMessageService, HelpButtonComponent, MessageDialogService
...
@Component({
    ...
    imports: [
        ...
        MatCheckboxModule, CurrencyInputComponent, LocalCurrencyPipe, HelpButtonComponent, MatTableModule, UpperCasePipe
    ],
...
export class SessionDetailComponent {
    ...
    save(): void {
        if (this.form.valid) {
            ...
            this.#packsSrv.packItems.update(this.packId, this.item.id, data)
                .subscribe({
                    next: () => {
