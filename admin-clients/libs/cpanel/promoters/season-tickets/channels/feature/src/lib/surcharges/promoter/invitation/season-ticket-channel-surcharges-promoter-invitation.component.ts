...
@Component({
    ...
    selector: 'app-season-ticket-channel-surcharges-promoter-invitation',
    templateUrl: './season-ticket-channel-surcharges-promoter-invitation.component.html'
})
export class SeasonTicketChannelSurchargesPromoterInvitationComponent implements OnInit, OnDestroy {
    ...
    readonly data$ = inject(SeasonTicketChannelsService).getSeasonTicketChannelSurcharges$()
        .pipe(
            filter(Boolean),
            map(surcharges =>
                surcharges
