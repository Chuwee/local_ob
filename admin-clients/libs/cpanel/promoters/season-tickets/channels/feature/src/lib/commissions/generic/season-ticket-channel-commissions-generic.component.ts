...
@Component({
    ...
    selector: 'app-season-ticket-channel-commissions-generic',
    templateUrl: './season-ticket-channel-commissions-generic.component.html'
})
export class SeasonTicketChannelCommissionsGenericComponent {
