...
@Component({
    ...
    selector: 'app-season-ticket-channel-surcharges-promoter-generic',
    templateUrl: './season-ticket-channel-surcharges-promoter-generic.component.html'
})
export class SeasonTicketChannelSurchargesPromoterGenericComponent implements OnInit, OnDestroy {
