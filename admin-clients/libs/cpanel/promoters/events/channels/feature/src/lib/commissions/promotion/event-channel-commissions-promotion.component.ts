...
@Component({
    ...
    selector: 'app-event-channel-commissions-promotion',
    templateUrl: './event-channel-commissions-promotion.component.html'
})
export class EventChannelCommissionsPromotionComponent {
