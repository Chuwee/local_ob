...
@Component({
    ...
    imports: [AsyncPipe, FormContainerComponent, TranslatePipe, MatLabel, MatCheckbox, MatProgressSpinner, ReactiveFormsModule, FlexModule, MatRadioButton, MatRadioGroup],
...
export class PackDesignComponent implements OnInit {
    ...
    save$(): Observable<void> {
        if (this.form.valid) {
            ...
            return this.#packsSrv.pack.update(this.$pack().channel_id, this.$pack().id, updatedPack)
