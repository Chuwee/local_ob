...
@Component({
    selector: 'app-channel-member-periods-change-seat-configs',
    templateUrl: './channel-member-periods-change-seat-configs.component.html',
...
export class ChannelMemberExternalPeriodsChangeSeatConfigsComponent implements OnInit, WritingComponent {
    ...
    save$(): Observable<void[]> {
        if (this.form.valid && this.form.dirty) {
            ...
            if (datesFilter) {
                ...
                obs$.push(this.#memberExtSrv.datesFilter.update(this.#channelId, MemberPeriods.change, datesFilterRequest));
            }
    ...
    private load(): void {
        this.#memberExtSrv.datesFilter.load(this.#channelId, MemberPeriods.change);
    }
}
