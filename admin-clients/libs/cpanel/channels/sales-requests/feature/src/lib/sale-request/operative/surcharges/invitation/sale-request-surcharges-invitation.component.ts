...
@Component({
    ...
    selector: 'app-sale-request-surcharges-invitation',
    templateUrl: './sale-request-surcharges-invitation.component.html'
})
export class SaleRequestSurchargesInvitationComponent implements OnInit, OnDestroy {
