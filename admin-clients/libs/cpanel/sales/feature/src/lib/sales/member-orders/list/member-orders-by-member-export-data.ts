...
export const exportDataMemberOrderByMember: FieldDataGroup[] = [
    {
    ...
    {
        fieldKey: 'MEMBER_ORDER.EXPORT.TICKET_DATA.TITLE',
        field: 'member_data',
        isDefault: false,
        fields: [
            {
                field: 'member_data.person_id',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.PERSON_ID',
                isDefault: true
            },
            {
                field: 'member_data.partner_id',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.PARTNER_ID',
                isDefault: true
            },
            {
                field: 'member_data.name',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.NAME',
                isDefault: true
            },
            {
                field: 'member_data.surname',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.SURNAME',
                isDefault: true
            },
            {
                field: 'member_data.dni',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.DNI',
                isDefault: true
            },
            {
                field: 'member_data.email',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.EMAIL',
                isDefault: true
            },
            {
                field: 'member_data.old_seat',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.OLD_SEAT',
                isDefault: true
            },
            {
                field: 'member_data.old_price',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.OLD_PRICE',
                isDefault: true
            },
            {
                field: 'member_data.seat',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.SEAT',
                isDefault: true
            },
            {
                field: 'member_data.base_price',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.BASE_PRICE',
                isDefault: true
            },
            {
                field: 'member_data.discounts',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.DISCOUNTS',
                isDefault: true
            },
            {
                field: 'member_data.charges',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.CHARGES',
                isDefault: true
            },
            {
                field: 'member_data.final_price',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.FINAL_PRICE',
                isDefault: true
            },
            {
                field: 'member_data.total_season_price',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.TOTAL_SEASON_PRICE',
                isDefault: false
            },
            {
                field: 'member_data.subscription_id',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.SUBSCRIPTION_ID',
                isDefault: true
            },
            {
                field: 'member_data.periodicity_id',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.PERIODICITY_ID',
                isDefault: true
            },
            {
                field: 'member_data.role_id',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.ROLE_ID',
                isDefault: true
            },
            {
                field: 'member_data.state',
                fieldKey: 'MEMBER_ORDER.EXPORT.MEMBER_DATA.STATE',
                isDefault: true
            }
        ]
    },
