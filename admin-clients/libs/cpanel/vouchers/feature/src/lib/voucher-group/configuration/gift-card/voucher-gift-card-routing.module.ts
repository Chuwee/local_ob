...
const routes: Routes = [{
    ...
    children: [
        ...
        {
            path: 'sale',
            component: GiftCardGroupSaleComponent,
            canDeactivate: [unsavedChangesGuard()],
            pathMatch: 'full',
            data: {
                breadcrumb: 'GIFT_CARD.SALE'
            }
        },
        {
            path: 'email',
            component: GiftCardGroupEmailComponent,
            canDeactivate: [unsavedChangesGuard()],
            pathMatch: 'full',
            data: {
                breadcrumb: 'GIFT_CARD.EMAIL'
            }
        }
    ]
}];
...
export class VoucherGiftCardRoutingModule {
}
