...
public class EventRateRestrictionsDTO implements Serializable {
    ...
    private RatePriceZoneRestrictionDTO ratePriceZoneRestriction;
    ...
    public RatePriceZoneRestrictionDTO getRatePriceZoneRestriction() {
        return ratePriceZoneRestriction;
    }

    public void setRatePriceZoneRestriction(RatePriceZoneRestrictionDTO ratePriceZoneRestriction) {
