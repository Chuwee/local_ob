...
public class SeasonTicketRenewalSeatsSummary implements Serializable {
    ...
    private SeasonTicketAutomaticRenewalStatus automaticRenewalStatus;
    ...
    public SeasonTicketAutomaticRenewalStatus getAutomaticRenewalStatus() {
        return automaticRenewalStatus;
    }

    public void setAutomaticRenewalStatus(SeasonTicketAutomaticRenewalStatus automaticRenewalStatus) {
