...
public class TierCommunicationElementDTO implements Serializable {
    ...
    public TierCommunicationElementDTO() {}

    public TierCommunicationElementDTO(String lang, String value, CommunicationElementType communicationElementType) {
        this.lang = lang;
        this.value = value;
