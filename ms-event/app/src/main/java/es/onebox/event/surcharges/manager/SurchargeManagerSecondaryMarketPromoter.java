...
public class SurchargeManagerSecondaryMarketPromoter extends SurchargeManager {

    private final RangeSurchargeEventSecondaryMarketDao rangeSurchargeEventSecMktDao;

    public SurchargeManagerSecondaryMarketPromoter(RangeDao rangeDao, RangeSurchargeEventSecondaryMarketDao rangeSurchargeEventSecMktDao, EventDao eventDao) {
