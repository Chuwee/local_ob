...
public enum SeasonTicketRenewalsField implements FileCode {
    ID("id"),
    USER_ID("user_id"),
    MEMBER_ID("member_id"),
    ...
    RENEWALS_SETTINGS_AUTORENEWAL("renewal_settings.auto_renewal"),
    ...
    SeasonTicketRenewalsField(final String code) {
        this.code = code;
    }
