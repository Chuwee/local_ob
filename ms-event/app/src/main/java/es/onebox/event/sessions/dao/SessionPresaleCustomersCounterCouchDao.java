...
@Repository
@CouchRepository(
        prefixKey = SessionPresaleCustomersCounterCouchDao.KEY,
        bucket = SessionPresaleCustomersCounterCouchDao.BUCKET,
        scope = SessionPresaleCustomersCounterCouchDao.SCOPE,
        collection = SessionPresaleCustomersCounterCouchDao.COLLECTION
)
public class SessionPresaleCustomersCounterCouchDao extends AbstractCounterCouchDao<Long> {

    public static final String KEY = "sessionPresaleCustomer";
