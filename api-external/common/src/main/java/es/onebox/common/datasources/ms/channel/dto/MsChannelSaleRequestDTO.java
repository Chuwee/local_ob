...
import es.onebox.common.datasources.ms.channel.enums.ChannelSubtype;
import es.onebox.common.datasources.ms.channel.enums.ChannelType;
...
public class MsChannelSaleRequestDTO implements Serializable {
    ...
    @Serial
    private static final long serialVersionUID = -4628998100888496423L;
    private Long id;
    private String name;
