...
public class RateFeverDTO implements Serializable {
    ...
    public RateFeverDTO(Long id, String name, String description, Boolean restrictive, Boolean defaultRate, Map<String, String> translations) {
        this.id = id;
        this.name = name;
