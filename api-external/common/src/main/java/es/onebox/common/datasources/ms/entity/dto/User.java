...
public class User implements Serializable {
    ...
    @Serial
    private static final long serialVersionUID = 9111403870341950994L;
    private Long id;
    ...
    public User(Long id, String name, String username, Long entityId, List<RoleDTO> roles, String password) {
        this.id = id;
        this.name = name;
