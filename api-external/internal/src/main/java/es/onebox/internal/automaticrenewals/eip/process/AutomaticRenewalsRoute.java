...
@Component
public class AutomaticRenewalsRoute extends RouteBuilder {

    private static final String REDELIVERY_TIME = "0";
    private static final String MAX_REDELIVERIES = "0";

    private final AutomaticRenewalsConsumer consumer;
    private final AutomaticRenewalsConfiguration configuration;

    @Autowired
    public AutomaticRenewalsRoute(AutomaticRenewalsConsumer consumer, AutomaticRenewalsConfiguration configuration) {
    ...
    private DeadLetterChannelBuilder errorHandlerBuilder() {
