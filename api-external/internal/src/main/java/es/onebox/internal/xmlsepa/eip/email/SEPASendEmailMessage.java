...
public class SEPASendEmailMessage extends AbstractNotificationMessage {
    ...
    private SEPASendEmailMessage(Builder builder) {
    ...
    public static final class Builder {
        ...
        public SEPASendEmailMessage build() {
            return new SEPASendEmailMessage(this);
        }
    }
